...
export default class qspqqdyysjhz extends React.Component {
    state = {
        orderInfo: {},
        list: [],
    }
    ...
    toExcel() {
        const data = [
            ...
            ['', 'VOD视频点播平台', 'OTT', 'IPTV', 'VOD视频点播平台', 'OTT', 'IPTV', 'VOD视频点播平台','OTT', 'IPTV', 'VOD视频点播平台','OTT', 'IPTV']
        ]
        ...
        XlSX.writeFile(wb, `全视频全渠道运营数据汇总.xlsx`)
    }
    componentDidMount() {
        this.requestList();
    }
    ...
    chaxun = (params) => {
        ...
        params.time2= Y2+M2
        axios.get("http://118.31.45.118:8888/lvyou-ssm1/qspqqdyyhuizong?time1=" + params.time1 + "&time2=" + params.time2,
        {
    ...
    requestList = () => {
        axios.get('http://118.31.45.118:8888/lvyou-ssm1/qspqqdyyhuizong',
        {
            withCredentials: true
        }   
        ).then((res) => {
