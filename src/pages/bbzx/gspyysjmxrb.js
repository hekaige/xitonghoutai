...
let list
export default class gspyysjmxrb extends React.Component {
    state = {
        shipinmingcheng: [],
        list: [],
        orderInfo: {},
    ...
    toExcel() {
        ...
        XlSX.writeFile(wb, `各视频运营数据明细日表.xlsx`)
    }
    componentDidMount() {
        this.requestList();
    }
    ...
    chaxun = (params) => {
        ...
        axios.get("http://118.31.45.118:8888/lvyou-ssm1/gspyysjribiao?name=" + params.name[0] +"&qdao="+ params.name[1]+ "&time1=" + params.time1 + "&time2=" + params.time2,
        {
    ...
    //默认请求接口数据
    requestList = () => {
        axios.get('http://118.31.45.118:8888/lvyou-ssm1/gspyysjribiao',
        {
            withCredentials: true
        }
        ).then((res) => {
