...
export default class bingtu2 extends React.Component {
    ...
    chaxun = (params) => {
        ...
        if (params.name == "" || params.name == null || params.time1 == "" || params.time1 == null || params.time2 == "" || params.time2 == null) {
            ...
            if (options == '1') {
                ...
                params.time2 = Y2 + M2
                axios.get("http://118.31.45.118:8888/lvyou-ssm1/dspsrsjmxyueline?name=" + params.name[0] + "&qdao=" + params.name[1] + "&time1=" + params.time1 + "&time2=" + params.time2,
                {
    ...
    getOption = () => {
        if (options == '1') {
            axios.get('http://118.31.45.118:8888/lvyou-ssm1/dspsrsjmxyueline?name=a&qdao=a&time1=2020-03&time2=2020-07',
            {
                withCredentials: true
            }
            ).then((res) => {
