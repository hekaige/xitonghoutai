...
let list
export default class yysjrb extends React.Component {
    state = {
        orderInfo: {},
        list: [],
    }
    ...
    chaxun = (params) => {
        ...
        console.log(params);
        let urls = "";
        if (params.videname == "" && params.qdao == "" && params.shijian == "") {
            message.warning('Emmmm，随便是什么意思？')
            this.requestList();
        }
        else {
            // if (params.videname != "") {
                urls = "http://118.31.45.118:8888/lvyou-ssm1/yyshujuricx?videname=" + params.videname+"&qdao=" + params.qdao+"&shijian=" + params.shijian;
            // } else if (params.qdname != "") {
            //     urls = "http://118.31.45.118:8888/lvyou-ssm1/yyshujuricx?qdname=" + params.qdname;
            // }
            // else if (params.shijian != "") {
            //     urls = "http://118.31.45.118:8888/lvyou-ssm1/yyshujuricx?shijian=" + params.shijian;
            // }
            // else if (params.bfliang != "") {
            //     urls = "http://118.31.45.118:8888/lvyou-ssm1/yyshujuricx?bfliang=" + params.bfliang;
            // }
            // else if (params.rdu != "") {
            //     urls = "http://118.31.45.118:8888/lvyou-ssm1/yyshujuricx?rdu=" + params.rdu;
            // }
            axios.get(urls,
                {
    ...
    //默认请求接口数据
    requestList = () => {
        axios.get('http://118.31.45.118:8888/lvyou-ssm1/yyshujuri',
            {
                withCredentials: true
            }
        ).then((res) => {
    ...
    hanleOperate = (type) => {
        ...
        if (type == 'create') {
            ...
            Modal.confirm({
                title: '确认删除',
                content: 'good bye my love',
                onOk() {
                    axios.get('http://118.31.45.118:8888/lvyou-ssm1/yyshujurisc?id=' + item.id,
                        {
                            withCredentials: true
                        }
                    ).then((res) => {
    ...
    handleSubmit = () => {
        ...
        if (data.name == null && data.qdao == null && data.qdfl == null) {
            ...
            if (data.name != null && data.qdao != null && data.qdfl != null) {
                ...
                let url = "http://118.31.45.118:8888/lvyou-ssm1/yyshujurizj?videname=" + data.videname + "&qdname=" + data.qdname + "&shijian=" + data.shijian + "&bfliang=" + data.bfliang + "&gkshij=" + data.gkshij + "&rdu=" + data.rdu + "&bofangzs=" + data.bofangzs + "&qdfl=" + data.qdfl;
                if (data.id != null) {
                    url = "http://118.31.45.118:8888/lvyou-ssm1/yyshujurizj?id=" + data.id + "&videname=" + data.videname + "&qdname=" + data.qdname + "&shijian=" + data.shijian + "&bfliang=" + data.bfliang + "&gkshij=" + data.gkshij + "&rdu=" + data.rdu + "&bofangzs=" + data.bofangzs + "&qdfl=" + data.qdfl;
                }
                axios.get(url,
                    {
                        withCredentials: true
...
class UserForm extends React.Component {//栅格结构
    ...
    handleUpload = () => {
        ...
        axios.get('http://118.31.45.118:8888/lvyou-ssm1/yysjrbdrr',
            {
                withCredentials: true
            }).then(res => {
                console.log(res, "返回")
                ...
                //有权限
                    ...
                    if (data.name != null && data.qdao != null && data.qdfl != null) {
                        reqwest({
                            url: "http://118.31.45.118:8888/lvyou-ssm1/yysjrbdr?name=" + data.name + "&qdao=" + data.qdao + "&qdfl=" + data.qdfl,   //这块是你项目的接口
                            method: 'post',
                            processData: false,
                            withCredentials: true,
                            data: formData,
